...
export const brands: Brand[] = [
  {
    ...
    body: [
      ...
      "Each creation is a testament to the brand's unwavering commitment to uniqueness — distinctively exquisite shapes, luxurious materials, and masterful hand-crafted artistry. The allure of Poltrona Frau lies in its ability to transform every space it touches into a haven of luxury and refinement.",
    ],
  ...
  },
  {
    ...
    body: [
      ...
      "Renowned for their contemporary design and unparalleled craftsmanship, Lema's creations are a seamless fusion of functionality and beauty — perfectly balancing elegance with modernity for a sophisticated global audience.",
    ],
  ...
  },
  {
    ...
    body: [
      "For over five decades, de Sede has been synonymous with exceptional leather craftsmanship and uncompromising Swiss quality. Founded on precision, innovation and artisanal expertise, the brand has earned an international reputation for furniture that is as enduring as it is distinctive.",
      "Renowned for its iconic designs and technical innovation, de Sede's collections reflect a commitment to authentic materials, exceptional comfort and timeless design. From sculptural seating to statement living spaces, it represents the pinnacle of luxury furniture — crafted to be cherished for generations.",
    ],
  ...
  },
  {
    ...
    body: [
      "SCIC stands as a paragon of premium kitchen manufacturing, celebrated for its technological innovation and impeccable workmanship. Renowned for kitchens that marry modernity with functionality, SCIC tailors each creation to the unique needs of its clients, with the utmost attention to materials and technique.",
      "SCIC's unwavering focus on design, quality and technology has established it as a leader in its industry. Its philosophy embraces the kitchen as a sanctuary where design and practicality converge harmoniously.",
    ],
    category: ["Kitchens"],
  ...
  },
  {
    ...
    body: [
      ...
      "Designed and crafted in India, Madheke embodies an elegant aesthetic where heritage meets innovation — creating enduring objects that bring character, warmth and sophistication to modern interiors. Its distinctive design language is rooted in detail, proportion and authenticity.",
    ],
  ...
  },
  {
    ...
    body: [
      "Founded amidst the vibrant spirit of Valencia, Spain, Gandia Blasco stands as an icon of modern luxury in outdoor furniture design. The essence of its creations lies in their purity of design — sleek architectural lines that embody a distinct personality.",
      "Each piece harmonises form and function with effortless elegance, transforming outdoor spaces into oases of style and comfort. Every collection resonates with a timeless allure, offering a blend of sophistication and practicality that transcends mere furniture to embody an elevated lifestyle.",
    ],
  ...
  },
  {
    ...
    origin: "India · Kerala",
    meta: "India · Rugs",
    tagline: "Handwoven carpets — texture, warmth and artistry.",
    description:
    ...
    body: [
      ...
      "Each piece reflects the brand's commitment to preserving artisanal techniques while embracing modern aesthetics — resulting in products that lend warmth and sophistication to the spaces they inhabit.",
    ],
